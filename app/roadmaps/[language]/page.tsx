    ...
    <div className="min-h-[calc(100vh-4rem)] bg-background">
      <div className="max-w-7xl mx-auto border-x-2 border-primary/20 min-h-screen pb-20">
        <div className="pt-20 pb-16 px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-semibold tracking-tight text-foreground font-kantumruy mb-6 capitalize">
            {language} Roadmap
          </h1>
          <p className="text-[17px] text-muted-foreground max-w-2xl mx-auto">
            ស្វែងយល់ពីជំហានបន្ទាប់របស់អ្នកនៅក្នុងការសរសេរកូដ។
          </p>
        </div>
        ...
        <div className="px-6 md:px-12 flex flex-col items-center">
          <div className="w-full max-w-4xl bg-canvas p-6 md:p-12 border-2 border-primary/20 shadow-sm relative overflow-hidden flex flex-col items-center">
            <h2 className="text-2xl font-bold mb-8">Integration Ecosystem</h2>
            <AnimatedBeamDemo />
          </div>
        </div>
      </div>

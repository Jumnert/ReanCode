    ...
    <div className="min-h-screen bg-[#faf9f5] dark:bg-[#181715] transition-colors pb-32">
      <div className="max-w-3xl mx-auto border-x-2 border-[#cc785c]/30 bg-[#faf9f5] dark:bg-[#181715]">
        ...
        <div className="pt-16 pb-10 px-6 md:px-10 text-center">
          ...
          <h1 className="text-[36px] md:text-[42px]  tracking-tight text-[#141413] dark:text-[#faf9f5] mb-4">
            {t('title')}
          </h1>
          <p className="text-[16px] text-[#6c6a64] dark:text-[#a09d96]  max-w-lg mx-auto">
            {t('description')}
          </p>
          
          <div className="flex justify-center gap-8 md:gap-12 mt-10">
            <div className="flex flex-col text-center">
              <span className="text-[28px]  font-bold text-[#141413] dark:text-[#faf9f5]">{progress.completedLessons}</span>
              <span className="text-[12px] text-[#8e8b82] dark:text-[#a09d96] font-medium uppercase tracking-wider mt-1">{t('lessons')}</span>
            </div>
            <div className="flex flex-col text-center">
              <span className="text-[28px]  font-bold text-[#141413] dark:text-[#faf9f5]">{formatTime(progress.totalTimeSpent)}</span>
              <span className="text-[12px] text-[#8e8b82] dark:text-[#a09d96] font-medium uppercase tracking-wider mt-1">{t('timeSpent')}</span>
            </div>
            <div className="flex flex-col text-center">
              <span className="text-[28px]  font-bold text-[#141413] dark:text-[#faf9f5]">{streak.count}</span>
        ...
        <div className="bg-[#faf9f5] dark:bg-[#181715]">
          {enrichedProgress.length > 0 ? (
              ...
              {enrichedProgress.map((p: any, index: number) => (
                ...
                >
                  <div className="flex items-center gap-4 min-w-[150px]">
                    ...
                    <span className="text-[18px] font-bold  text-[#141413] dark:text-[#faf9f5] capitalize">
                      {p.title}
                    </span>
                  </div>
            ...
            <div className="p-16 text-center">
              ...
              <h3 className="text-[22px]  font-bold mb-3 text-[#141413] dark:text-[#faf9f5]">{t('noHistory')}</h3>

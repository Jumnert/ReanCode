...
export default function VerifyOTPPage() {
 ...
 <InputOTPGroup>
 <InputOTPSlot index={0} className="border-[#e0e0e0] dark:border-zinc-800 focus-visible:ring-[var(--primary)] text-[17px]" />
 <InputOTPSlot index={1} className="border-[#e0e0e0] dark:border-zinc-800 focus-visible:ring-[var(--primary)] text-[17px]" />
 <InputOTPSlot index={2} className="border-[#e0e0e0] dark:border-zinc-800 focus-visible:ring-[var(--primary)] text-[17px]" />
 </InputOTPGroup>
 <InputOTPSeparator className="text-[#7a7a7a]" />
 <InputOTPGroup>
 <InputOTPSlot index={3} className="border-[#e0e0e0] dark:border-zinc-800 focus-visible:ring-[var(--primary)] text-[17px]" />
 <InputOTPSlot index={4} className="border-[#e0e0e0] dark:border-zinc-800 focus-visible:ring-[var(--primary)] text-[17px]" />
 <InputOTPSlot index={5} className="border-[#e0e0e0] dark:border-zinc-800 focus-visible:ring-[var(--primary)] text-[17px]" />
 </InputOTPGroup>
 </InputOTP>
 </div>
 ...
 <Button
 type="submit"
 className="w-full h-11 bg-primary hover:bg-primary text-white font-medium rounded-full text-[15px] transition-transform active:scale-[0.95]"

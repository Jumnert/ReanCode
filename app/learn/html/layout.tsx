    ...
    <>
      ...
      <SidebarInset className="bg-transparent text-foreground min-h-[calc(100vh-64px)]">
        <div className="flex h-12 items-center border-b border-border/40 px-4 md:px-6 bg-card/50 backdrop-blur-sm sticky top-0 z-10">
          <SidebarTrigger className="text-[#0066cc]" />
          <span className="ml-2 font-medium text-sm">HTML Learning</span>
          {/* Compiler shortcut */}
          <a
            href="#compiler"
            className="ml-auto flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#0066cc] hover:bg-[#0071e3] text-white text-xs font-medium transition-colors"
          >

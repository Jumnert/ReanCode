...
import { Code2, Info, Lightbulb, AlertTriangle, CheckCircle2 } from "lucide-react"
...
<head>
<style>
  body { font-family: sans-serif; padding: 16px; line-height: 1.8; }
...
<body>
  ...
  <div class="card">
    <b>Inline CSS:</b>
    <p style="color:tomato; font-size:18px; margin:6px 0;">
...
function Note({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex gap-3 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4 text-sm text-blue-900 dark:text-blue-200">
...
function Tip({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex gap-3 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg p-4 text-sm text-amber-900 dark:text-amber-200">
...
function Warn({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex gap-3 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-lg p-4 text-sm text-red-900 dark:text-red-200">
...
function Good({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex gap-3 bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-lg p-4 text-sm text-green-900 dark:text-green-200">
...
function CodeBlock({ children }: { children: string }) {
  return (
    <pre className="bg-zinc-900 text-zinc-100 p-4 rounded-lg font-mono text-sm overflow-x-auto leading-relaxed border border-zinc-700">
      {children}
    </pre>
  )
}
    ...
    <div className="flex w-full min-h-screen">
      <div className="flex-1 max-w-4xl mx-auto px-4 md:px-8 py-10 pb-24">
        ...
        <div className="space-y-4 mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#0066cc]/10 text-[#0066cc] text-xs font-medium">
        ...
        <div className="divide-y divide-zinc-200 dark:divide-zinc-800 [&>section]:py-16 first:[&>section]:pt-0">
          ...
          {/* ══════════════════════════════════════════════
              ១. INTRODUCTION
          ══════════════════════════════════════════════ */}
          <section id="intro" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">១</span>
...
<body>
  ...
  <p>HTML គឺជាមូលដ្ឋានគ្រឹះ
     របស់ Web Development។</p>
            ...
            <h3 className="font-semibold text-foreground">🧪 សាកល្បងខ្លួនឯង</h3>
          ...
          {/* ══════════════════════════════════════════════
              ២. EDITORS
          ══════════════════════════════════════════════ */}
          <section id="editors" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">២</span>
              <h2 className="text-2xl font-bold text-foreground">
              ...
              {[
                ...
                <div key={name} className={`rounded-lg border p-4 ${color}`}>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs px-2 py-0.5 rounded-full bg-white/60 dark:bg-black/20 border text-muted-foreground">{badge}</span>
                  </div>
          ...
          {/* ══════════════════════════════════════════════
              ៣. BASIC
          ══════════════════════════════════════════════ */}
          <section id="basic" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">៣</span>
              <h2 className="text-2xl font-bold text-foreground">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                ...
                <div key={tag} className="flex gap-3 p-3 rounded-lg border bg-card">
                  <code className="shrink-0 font-mono text-xs bg-zinc-900 text-green-400 px-2 py-1 rounded h-fit">{tag}</code>
...
<body>
  ...
  <p>Paragraph text...</p>
            ...
            <h3 className="font-semibold text-foreground">🧪 សាកល្បង</h3>
          ...
          {/* ══════════════════════════════════════════════
              ៤. ELEMENTS
          ══════════════════════════════════════════════ */}
          <section id="elements" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">៤</span>
              <h2 className="text-2xl font-bold text-foreground">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border border-blue-100 dark:border-blue-800 rounded-xl p-5">
              <div className="flex items-center justify-center gap-1 font-mono text-sm flex-wrap">
                <span className="px-3 py-2 bg-green-200 dark:bg-green-800 rounded-lg text-green-900 dark:text-green-100 font-bold">&lt;p&gt;</span>
                <span className="px-4 py-2 bg-white dark:bg-zinc-800 rounded-lg border text-foreground">ខ្លឹមសារ Content</span>
                <span className="px-3 py-2 bg-red-200 dark:bg-red-800 rounded-lg text-red-900 dark:text-red-100 font-bold">&lt;/p&gt;</span>
              </div>
...
<div>
  <p>នេះ <strong>ខុស</div> !</strong>
          ...
          {/* ══════════════════════════════════════════════
              ៥. ATTRIBUTES
          ══════════════════════════════════════════════ */}
          <section id="attributes" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">៥</span>
              <h2 className="text-2xl font-bold text-foreground">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 border border-purple-100 dark:border-purple-800 rounded-xl p-5">
              <div className="flex items-center justify-center gap-1 font-mono text-sm flex-wrap">
                <span className="px-2 py-2 bg-blue-200 dark:bg-blue-800 rounded text-blue-900 dark:text-blue-100">&lt;a</span>
                <span className="px-2 py-2 bg-orange-200 dark:bg-orange-800 rounded text-orange-900 dark:text-orange-100">href</span>
                <span className="px-1 py-2 text-muted-foreground">=</span>
                <span className="px-2 py-2 bg-green-200 dark:bg-green-800 rounded text-green-900 dark:text-green-100">"https://..."</span>
                <span className="px-2 py-2 bg-blue-200 dark:bg-blue-800 rounded text-blue-900 dark:text-blue-100">&gt;</span>
              </div>
            </div>
                ...
                <tbody className="divide-y divide-border">
                  {[
                    ...
                    <tr key={attr} className="hover:bg-muted/50">
                      <td className="p-3 font-mono text-[#0066cc] text-xs">{attr}</td>
          ...
          {/* ══════════════════════════════════════════════
              ៦. HEADINGS
          ══════════════════════════════════════════════ */}
          <section id="headings" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">៦</span>
              <h2 className="text-2xl font-bold text-foreground">
...
<h4>ចំណងជើងរង</h4>`}</CodeBlock>
          ...
          {/* ══════════════════════════════════════════════
              ៧. PARAGRAPHS
          ══════════════════════════════════════════════ */}
          <section id="paragraphs" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">៧</span>
              <h2 className="text-2xl font-bold text-foreground">
...
<p>Section ទី ២</p>`,
  ...
  age:  25
                ...
                <div key={title} className="rounded-lg border bg-card p-4 space-y-2">
                  ...
                  <pre className="bg-zinc-900 text-zinc-100 text-xs p-3 rounded font-mono overflow-x-auto">{c}</pre>
          ...
          {/* ══════════════════════════════════════════════
              ៨. STYLES
          ══════════════════════════════════════════════ */}
          <section id="styles" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">៨</span>
              <h2 className="text-2xl font-bold text-foreground">
...
body { font-family: sans-serif; }`,
                ...
                <tbody className="divide-y divide-border">
                  {[
                    ...
                    <tr key={prop} className="hover:bg-muted/50">
                      <td className="p-3 font-mono text-[#0066cc]">{prop}</td>
          ...
          {/* ══════════════════════════════════════════════
              ៩. FORMATTING
          ══════════════════════════════════════════════ */}
          <section id="formatting" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">៩</span>
              <h2 className="text-2xl font-bold text-foreground">
          ...
          <section id="comments" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">១០</span>
              <h2 className="text-2xl font-bold text-foreground">
...
-->`}</CodeBlock>
          ...
          {/* ══════════════════════════════════════════════
              ១១. LINKS
          ══════════════════════════════════════════════ */}
          <section id="links" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">១១</span>
              <h2 className="text-2xl font-bold text-foreground">
...
<a href="/file.pdf" download>Download PDF</a>`}</CodeBlock>
          ...
          {/* ══════════════════════════════════════════════
              ១២. IMAGES
          ══════════════════════════════════════════════ */}
          <section id="images" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">១២</span>
              <h2 className="text-2xl font-bold text-foreground">
...
>`}</CodeBlock>
          ...
          {/* ══════════════════════════════════════════════
              ១៣. TABLES
          ══════════════════════════════════════════════ */}
          <section id="tables" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">១៣</span>
              <h2 className="text-2xl font-bold text-foreground">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={tag} className="flex gap-2 items-start">
                  <code className="shrink-0 font-mono text-[11px] bg-zinc-900 text-green-400 px-2 py-0.5 rounded">{tag}</code>
    ...
    <tr>
      ...
      <td>សៀមរាប</td>
          ...
          {/* ══════════════════════════════════════════════
              ១៤. LISTS
          ══════════════════════════════════════════════ */}
          <section id="lists" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0066cc] text-white text-sm font-bold shrink-0">១៤</span>
              <h2 className="text-2xl font-bold text-foreground">
...
ol { list-style-type: lower-alpha; } /* a, b, c */`}</CodeBlock>
          ...
          {/* ══════════════════════════════════════════════
              ១៥. FULL PLAYGROUND
          ══════════════════════════════════════════════ */}
          <section id="compiler" className="scroll-mt-20 space-y-5">
            <div className="flex items-center gap-3 border-b pb-3">
